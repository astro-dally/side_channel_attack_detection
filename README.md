...
├── data_extraction_code/     # Scripts for data collection & preprocessing
├── notebooks/                # Jupyter notebook pipeline (SideChannel_AI_Research_Pipeline.ipynb)
├── presentation/             # HTML slide deck (progress_report_presentation.html)
├── report/                   # IEEE‑style LaTeX paper (main.tex, references.bib)
...
├── Makefile                  # Build shortcuts for report and presentation
├── README.md                 # This file
...
- **Python 3.11+** with packages listed in `requirements.txt` (e.g., `pandas`, `scikit‑learn`, `torch`, `matplotlib`).
...
If you use this work in your research, please cite it using the provided BibTeX entry in `report/references.bib`.
